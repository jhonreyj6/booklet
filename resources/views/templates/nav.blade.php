        ...
        @auth
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse gap-4">
                <form action="/logout" method="POST">
                    @csrf
                    <button type="submit"
                        class="flex text-white bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                        Logout
                    </button>
                </form>
                <button type="button"
                    ...
                    <img class="w-8 h-8 rounded-full" src="https://www.w3schools.com/howto/img_avatar.png" alt="user photo">
                </button>
                <!-- Dropdown menu -->
