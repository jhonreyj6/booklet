    ...
    <div class="mt-32">
        <div class="max-w-md mx-auto">
            ...
            <div class="mb-4">
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-1 text-lg">
                        <a href="{{ route('redirect.provider', ['provider' => 'facebook']) }}"
                            class="block text-center py-2 rounded font-semibold bg-blue-700 text-white"><i
                                class="fa-brands fa-square-facebook"></i> Facebook</a>
                    </div>
                    <div class="col-span-1 text-lg">
                        <a href="{{ route('redirect.provider', ['provider' => 'google']) }}"
                            class="text-center block py-2 rounded font-semibold bg-red-500 text-white"><i
            ...
            <form action="/login" method="POST">
                @if (app('router')->getRoutes()->match(app('request')->create(URL::previous()))->getName() == 'book')
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                Forgot Password?
                <a href="/password/reset" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Reset
                    here.</a>
            </p>
        </div>
    </div>
